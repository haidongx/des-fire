...
public class DrawFigure6
{
	...
	private static void showSymResults()
	{
		...
		int[] fireResSet = {10}; // 10, 30, 90
		int[] arpsResSet = {90}; // 10, 30, 90
		
		String folder = "C:/Users/Haydon/Google Drive/DEVSFIRE_ARPS Coupling/IJWF Revision/Simulation data/figure6data/HeatmapFiles_u3_shortgrass/";
				...
				for (int u : us)
				{
					...
					try
					{
						...
						
						{
							...
							String heatfolder = folder + "HeatmapFiles_u3_shortgrass_uncoupled/";
							p.drawHeatfilesOutline(heatfolder, stepLength, startStep, endStep, Color.black);
							System.out.println(name+ "uncoupled done" );
						}
						
						{
							String heatfolder = folder + "HeatmapFiles_u3_shortgrass_coupled/";
