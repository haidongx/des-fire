...
public class BehaveDeriv extends Behave {
  ...
  public void setParameterStdv(String key, double value) {
    // evaluate String...
    if      (key.equalsIgnoreCase("w0_d1")) stdv[0]  = value;
    else if (key.equalsIgnoreCase("w0_d2")) stdv[1]  = value;
    else if (key.equalsIgnoreCase("w0_d3")) stdv[2]  = value;
    else if (key.equalsIgnoreCase("w0_lh")) stdv[3]  = value;
    else if (key.equalsIgnoreCase("w0_lw")) stdv[4]  = value;
    else if (key.equalsIgnoreCase("m_d1"))  stdv[5]  = value;
    else if (key.equalsIgnoreCase("m_d2"))  stdv[6]  = value;
    else if (key.equalsIgnoreCase("m_d3"))  stdv[7]  = value;
    else if (key.equalsIgnoreCase("m_lh"))  stdv[8]  = value;
    else if (key.equalsIgnoreCase("m_lw"))  stdv[9]  = value;
    else if (key.equalsIgnoreCase("sv_d1")) stdv[10] = value;
    else if (key.equalsIgnoreCase("depth")) stdv[11] = value;
    else if (key.equalsIgnoreCase("mx"))    stdv[12] = value;
    else if (key.equalsIgnoreCase("wsp"))   stdv[13] = value;
    else if (key.equalsIgnoreCase("wdr"))   stdv[14] = Math.toRadians(value);
    else if (key.equalsIgnoreCase("slp"))   stdv[15] = Math.toRadians(value);
    else if (key.equalsIgnoreCase("asp"))   stdv[16] = Math.toRadians(value);
  }
  ...
  public double getValue(String key) {
    ...
    if (varHashMap.containsKey(key)) {
      res = ((Double) varHashMap.get(key)).doubleValue();
      keyFound = true;
    }
    if (resHashMap.containsKey(key)) {
      res = ((Double) resHashMap.get(key)).doubleValue();
      keyFound = true;
    }
    //
  ...
  protected void calcPartialDerivatives() {
	...
	*/
    ...
    if (wsp > 0.) {
      ...
      efw_dw0_d1 = efw_A * (
        - B_dw0_d1*efw_log * C                 *beta_ratio       *vl
        - B * C_dw0_d1                         *beta_ratio       *vl
        + B * C * E_dw0_d1*Math.log(beta_ratio)*beta_ratio       *vl
        + B * C * E                            *beta_ratio_dw0_d1*vl
        + B * C                                *beta_ratio       *vl_dw0_d1);
      ...
      efw_dw0_d3 = efw_A * (
        -B_dw0_d3 * efw_log * C                    * beta_ratio * vl
        - B * C_dw0_d3                           * beta_ratio        * vl
        + B * C * E_dw0_d3 * Math.log(beta_ratio)* beta_ratio        * vl
        + B * C * E                              * beta_ratio_dw0_d3 * vl
        + B * C                                  * beta_ratio      *vl_dw0_d3);

      efw_dw0_lh = efw_A * (
        -B_dw0_lh * efw_log * C                  * beta_ratio * vl
        - B * C_dw0_lh                           * beta_ratio        * vl
        + B * C * E_dw0_lh * Math.log(beta_ratio)* beta_ratio        * vl
        + B * C * E                              * beta_ratio_dw0_lh * vl
        + B * C                                  * beta_ratio      *vl_dw0_lh);

      efw_dw0_lw = efw_A * (
        -B_dw0_lw * efw_log * C                  * beta_ratio * vl
        - B * C_dw0_lw                           * beta_ratio        * vl
        + B * C * E_dw0_lw * Math.log(beta_ratio)* beta_ratio        * vl
        + B * C * E                              * beta_ratio_dw0_lw * vl
        + B * C                                  * beta_ratio      *vl_dw0_lw);

      efw_dsv_d1 = efw_A * (
        -B_dsv_d1 * efw_log * C                  * beta_ratio * vl
        - B * C_dsv_d1                           * beta_ratio        * vl
        + B * C * E_dsv_d1 * Math.log(beta_ratio)* beta_ratio        * vl
        + B * C * E                              * beta_ratio_dsv_d1 * vl
        + B * C                                  * beta_ratio      *vl_dsv_d1);

      // depth
      efw_ddepth = efw * ( vl_ddepth * beta_ratio + vl*E*beta_ratio_ddepth)
        / (B*vl*beta_ratio) ;
